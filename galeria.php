...
<div class="container" style="margin-top:30px">
  <div class="row">
    <div class="col-sm-4">
      ...
      <hr class="d-sm-none">
      <!-- <ul class="nav nav-pills flex-column">
      <a class="twitter-timeline" data-lang="es" data-width="400" data-height="300" data-theme="light" href="https://twitter.com/RCD_Mallorca?ref_src=twsrc%5Etfw">Tweets by RCD_Mallorca</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
<div class="row">
    <div class="col-md-4">
      <div class="thumbnail">
        <a href="img/fondo2.jpg" target="_blank">
          <img src="img/fondo2.jpg" alt="Lights" style="width:100%">
          <div class="caption">
            <p>Celebración de la afición del RCD Mallorca tras el ascenso</p>
          </div>
        </a>
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
        <a href="img/fondoplantilla2.jpeg" target="_blank">
          <img src="img/fondoplantilla2.jpeg" alt="Nature" style="width:100%">
          <div class="caption">
            <p>Dani Rodríguez celebrando el gol vs Albacete</p>
          </div>
        </a>
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
        <a href="img/pruebafondo3.jpg" target="_blank">
          <img src="img/pruebafondo3.jpg" alt="Fjords" style="width:100%">
          <div class="caption">
            <p>Budimir celebra el primer gol de la remontada</p>
          </div>
        </a>
      </div>
    </div>
    ...
    <hr class="barra">
    <button type="button" class="btn btn-info" style="text-align: center; margin: 0 auto" data-toggle="collapse" data-target="#demo">Ver más</button>
  <div id="demo" class="collapse"><br>
  <div class="row">
    <div class="col-md-4">
      <div class="thumbnail">
        <a href="img/foto_3.jpg" target="_blank">
          <img src="img/foto_3.jpg" alt="Lights" style="width:100%">
          <div class="caption">
            <p>Los jugadores celebran el gol de Leo Suárez</p>
          </div>
        </a>
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
        <a href="img/gol_abdon.jpg" target="_blank">
          <img src="img/gol_abdon.jpg" alt="Nature" style="width:100%">
          <div class="caption">
            <p>Abdón Prats besando el escudo</p>
          </div>
        </a>
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
        <a href="img/pruebafondo2.jpeg" target="_blank">
          <img src="img/pruebafondo2.jpeg" alt="Fjords" style="width:100%">
          <div class="caption">
            <p>Alineación del Mallorca</p>
          </div>
        </a>
      </div>
    </div>
