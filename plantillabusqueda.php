...
<html lang="es">
<head>
<title>RCD Mallorca | Búsqueda jugador</title>
  ...
  <div class="row">
    <div class="col-sm-4">
      ...
      <ul class="nav nav-pills flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="plantilla.php">Plantilla</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="calendario.php">Calendario</a>
        </li>
    ...
    <div class="col-sm-8">   
    <h2 style="text-align: center">Plantilla del RCD Mallorca</h2>
    <br>
...
if ($con->connect_errno){
    ...
    // echo "<hr>";
    echo "<a href='plantilla.php'>Volver atrás</a>";
    echo "<br><br>";
}
//buscador//
