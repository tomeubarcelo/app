...
<html lang="es">
<head>
<title>RCD Mallorca | Calendario</title>
...
<div class="container" style="margin-top:30px">
  <div class="row">
    ...
    <!--seccion noticias-->
    <div class="col-sm-8">
    <h2>El Mallorca ya conoce su calendario</h2>
      <!-- <h5>Title description, Sep 2, 2017</h5> -->
      <div class="fakeimg"><img class="img-fluid imagenes" alt="Calendario"
       title="Jornada 1 Liga Santander" src="img/calendario1.jpg" width="100%"></div>

      <p>Debutará en Son Moix el sábado 17 contra el Eibar</p>
      <hr class="barra">
     <p>El Real Mallorca ya sabe el camino que le aguarda la próxima temporada en su regreso a Primera División. El campeonato liguero 2019-20, que ha dado la bienvenida tanto al conjunto bermellón como Osasuna y Granada, alzará el telón el próximo 18 de agosto y terminará el 24 de mayo de 2020.</p>
   
     <img class="img-fluid imagenes" alt="Calendario"
       title="Sorteo calendario" src="img/sorteocalendario.jpg" width="100%"><br><br>
   <p>El conjunto de Vicente Moreno iniciará la liga el fin de semana del 18 de agosto en Son Moix ante el Eibar y la terminará el fin de semana del 24 de mayo de 2020 visitando a Osasuna en la jornada 38.

El primer Clásico de la temporada se jugará en el Camp Nou el 27 de octubre dentro de la décima jornada de Liga en Primera división y la vuelta se disputará el 1 de marzo en el Santiago Bernabéu dentro de la 26.

La Federación Española de Fútbol (RFEF) sorteó este jueves el calendario de la próxima campaña, que empezará el 18 de agosto y terminará el 24 de mayo.</p>
   
<h5><a href="pdf/calendario_primera.pdf" target="_blank">Ver el calendario completo</a></h5>
</div>
  </div>
