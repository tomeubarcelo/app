...
<html lang="es">
<head>
<title>RCD Mallorca | Nuevas equipaciones</title>
  ...
  <div class="row">
    <div class="col-sm-4">
      ...
      <ul class="nav nav-pills flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="noticias.php">Últimas noticias</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="plantilla.php">Plantilla</a>
        </li>
      ...
      <hr class="d-sm-none">
      <ul class="nav nav-pills flex-column">
      <a class="twitter-timeline" data-lang="es" data-width="400" data-height="1100" data-theme="light" href="https://twitter.com/RCD_Mallorca?ref_src=twsrc%5Etfw">Tweets by RCD_Mallorca</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>

      </ul>
    </div>
    <!--seccion noticias-->
    <div class="col-sm-8">
    <h2>El Mallorca presenta sus camisetas de Primera</h2>
      ...
      <h4>El Real Mallorca ya luce sus camisetas de la temporada 2019-20, la del retorno a Primera División.</h4>
      <hr class="barra">
      <p>La primera equipación es totalmente roja con un detalle en negro en el cuello y las mangas. El pantalón 
          también es en negro. La segunda es blanca, con el cuello y el final de las mangas en rojo y la principal 
          novedad radica en la tercera equipación, que es negra con las mangas y el pantalón en rosa.</p>

          <blockquote class="twitter-tweet"><p lang="es" dir="ltr">⚽️ 4 jugadores y un RETO<br><br>🎁 Un premio: las nuevas equipaciones 2019-20 <br><br>🎮 El resultado y las camisetas del retorno a Primera...⤵️ <a href="https://t.co/Rfh98pcklR">pic.twitter.com/Rfh98pcklR</a></p>&mdash; RCD Mallorca (@RCD_Mallorca) <a href="https://twitter.com/RCD_Mallorca/status/1155769165900374016?ref_src=twsrc%5Etfw">July 29, 2019</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
    <p>Cabe recordar que el equipo mallorquinista se desplazará este martes a Marbella para realizar la segunda parte
         de la pretemporada. En el primer tramo, el conjunto dirigido por Vicente Moreno ha disputado tres partidos amistosos
         en la isla ante el Felanitx (4-0), el Playas de Calvià (3-0) y el Poblense (1-1).</p>
    </div>
  </div>
