...
<html lang="es">
<head>
<title>RCD Mallorca | Mi perfil</title>
...
<div class="container" style="margin-top:30px">
  <div class="row">
    <div class="col-sm-4">
      ...
      <hr class="d-sm-none">
      <ul class="nav nav-pills flex-column">
      <a class="twitter-timeline" data-lang="es" data-width="400" data-height="400" data-theme="light" href="https://twitter.com/RCD_Mallorca?ref_src=twsrc%5Etfw">Tweets by RCD_Mallorca</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
<?php    
$sql="SELECT * FROM usuarios WHERE `usuario` = '$login_session' and `password`= '$login_password'"; //query es la consulta de sql//
$result = $db->query($sql);
   ...
   while($row = $result->fetch_assoc()) //crear la query de datos//

    {
      echo "<div class='img-fluid card' >";
        echo "<h4> Perfil de: ".utf8_encode($row['nombre']).'</h4>';
        echo "<img class='card-img-top' src=".$row['foto']." width='30%' style='margin: 0 auto'>";
        echo "<div class='card-body'>";

        echo "<p class='card-text'> Nombre de usuario: ".$row['usuario'].'</p>';
        echo "<p class='card-text'> ID: ".$row['id_usuario'].'</p>';
...
?> <!-- Button trigger modal -->
 <br>
   <!-- <a href="modifyuserprofile.php" class="btn btn-info" role="button"><i class="fas fa-external-link-alt"></i>  Modificar datos</a> -->
...
?> 
<!--eliminar cuenta-->
<a href="#" class="btn btn-danger botonDelete" role="button"><i class="fas fa-trash"></i>  Eliminar cuenta</a>
<script>
$(document).ready(function(){
	$(".botonDelete").click(function(){
        confirm('¿Realmente desea borrar su cuenta?');
   ...
   <p> <a href="accounts.php">Ver todas las cuentas registradas</a></p>
</div>
