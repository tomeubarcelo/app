...
<html lang="es">
<head>
<title>RCD Mallorca | Partido amistoso vs Poblense</title>
...
<div class="container" style="margin-top:30px">
  <div class="row">
    <div class="col-sm-4">
      ...
      <hr class="d-sm-none">
      <ul class="nav nav-pills flex-column">
      <a class="twitter-timeline" data-lang="es" data-width="400" data-height="1200" data-theme="light" href="https://twitter.com/RCD_Mallorca?ref_src=twsrc%5Etfw">Tweets by RCD_Mallorca</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>

      </ul>
    </div>
    <!--seccion noticias-->
    <div class="col-sm-8">
    <h2>1-1: El Mallorca no pasa del empate ante el Poblense</h2>
      <!-- <h5>Title description, Sep 2, 2017</h5> -->
      <div class="fakeimg"><img class="img-fluid imagenes" alt="Gol Mallorca"
       title="Gol de Joan Sastre" src="img/gol_joansastre.jpg" width="100%"></div>

      <h4>El equipo de Vicente Moreno se irá el martes a una concentración de pretemporada a Marbella donde se medirá a Málaga, Valladolid y Getafe.</h4>
      <hr class="barra">
<p>El Mallorca ha empatado este domingo 1-1 con el Poblense en el tercer y último de sus amistosos disputado frente a equipos de la Tercera División de la isla, antes de iniciar un período de concentración entre el 30 del julio y el 8 de agosto en Marbella.</p>

<p>Los goles del partido disputado en las instalaciones de Son Bibiloni del Mallorca fueron marcados por Joan Sastre (min. 24) y Mateu Ferrer (min. 89).</p>

<p>El equipo bermellón ha anotado 8 goles en los triunfos ante el Felanitx (4-0), Playas de Calviá (3-0) y Poblense (1-1), dos de ellos, a cargo del hasta ahora su máximo goleador el argentino Pablo Chavarría, que procede del Stade de Reims francés.</p>
<img class="img-fluid imagenes" alt="Gol Mallorca"
       title="Dani Rodríguez durante una acción del partido" src="img/mallorca_poblense.jpg" width="100%">    
</div>
  </div>
